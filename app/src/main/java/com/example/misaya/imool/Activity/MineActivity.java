...
public class MineActivity extends Activity{
    ...
    private void bottomMuem(){
        Button home = (Button) findViewById(R.id.btn_min_home);
        Button discovery = (Button) findViewById(R.id.btn_min_discovery);
        ImageView middle = (ImageView) findViewById(R.id.iv_min_middle);
        Button _class = (Button) findViewById(R.id.btn_min_class);
        Button mine = (Button) findViewById(R.id.btn_min_mine);
        ...
        discovery.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MineActivity.this, DiscoveryActivity.class);
                startActivity(intent);
            }
        });
